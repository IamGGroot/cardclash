...
export const CARDS = [
  ...
  { id: 'g7', faction: 'ignara', name: 'Chispa Ardiente', rarity: 'common', type: 'spell', cost: 2, requirement: 2, target: 'enemy_any', effect: 'damage_3', value: 3, silhouette: 'fireball', text: '3 de daño a una criatura o al héroe enemigo.' },
  ...
  { id: 'g16', faction: 'ignara', name: 'Grito de Guerra', rarity: 'common', type: 'spell', cost: 1, requirement: 1, target: 'enemy_any', effect: 'damage_2', value: 2, silhouette: 'fireball', text: '2 de daño a una criatura o al héroe enemigo.' },
  ...
  { id: 'u20', faction: 'umbra', name: 'Guardián de Huesos', rarity: 'rare', type: 'creature', cost: 3, requirement: 3, placement: 'melee', atk: 2, retaliate: 3, life: 5, silhouette: 'wall' },
  ...
  { id: 't5', faction: 'terra', name: 'Escudo de Clan', rarity: 'common', type: 'creature', cost: 3, requirement: 2, placement: 'melee', atk: 2, retaliate: 3, life: 5, silhouette: 'wall' },
  ...
  { id: 't11', faction: 'terra', name: 'Ogro de Clan', rarity: 'rare', type: 'creature', cost: 4, requirement: 3, placement: 'melee', atk: 5, retaliate: 2, life: 5, silhouette: 'titan' },
  ...
  { id: 't14', faction: 'terra', name: 'Guardia Cíclope', rarity: 'rare', type: 'creature', cost: 4, requirement: 3, placement: 'melee', atk: 3, retaliate: 4, life: 6, silhouette: 'golem' },
  ...
  { id: 't18', faction: 'terra', name: 'Bendición de Piedra', rarity: 'rare', type: 'fortune', cost: 3, requirement: 2, target: 'ally_creature', effect: 'buff_3_3', value: 3, silhouette: 'storm', text: 'Una criatura aliada gana +3/+3.' },
  ...
  { id: 't20', faction: 'terra', name: 'Behemot de Clan', rarity: 'epic', type: 'creature', cost: 5, requirement: 5, placement: 'melee', atk: 5, retaliate: 5, life: 7, silhouette: 'titan' },
  ...
  { id: 'n2', faction: 'neutral', name: 'Titán de Piedra', rarity: 'common', type: 'creature', cost: 5, requirement: 4, placement: 'melee', atk: 3, retaliate: 1, life: 4, silhouette: 'titan' },
  ...
  { id: 'n13', faction: 'neutral', name: 'Tormenta Errante', rarity: 'rare', type: 'spell', cost: 4, requirement: 3, target: 'enemy_any', effect: 'damage_3', value: 3, silhouette: 'storm', text: '3 de daño a una criatura o al héroe enemigo.' },
